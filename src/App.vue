...
<template>
    <div class="container">
        <header class="p-5 mb-4 mt-4 bg-light rounde-3">
        ...
        <form @submit.prevent="cadastraTarefa()">
            <div class="row">
                <div class="col">
                    <input :value="estado.tarefaTemp" @change="evento => estado.tarefaTemp = evento.target.value" required type="text" placeholder="digite a descriçao da tarefa" class="form-control">
                </div>
                <div class="col-md-2">
